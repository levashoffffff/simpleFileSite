<?php
    if(!empty($_POST['title']) && !empty($_POST['text'])) {
        ...
        //Массив в файл записать нельзя, можно только строки
        //Преобразует массив в строку
        $data = serialize($data);
        //Помещаем строку в файл 1.txt
        ...
        <div class="row">
            <form action="" method="post">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control-plaintext" id="staticEmail" placeholder="Enter text" name="title">
                    </div>
                </div>
                <div class="mb-3">
